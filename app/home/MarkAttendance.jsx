import { Pressable, TouchableOpacity, StyleSheet, Text, View, ScrollView } from "react-native";
...
const MarkAttendance = () => {
  ...
  const goToNextDay = (currentDate) => {
    const nextDate = moment(currentDate).add(1, "days");
    setCurrentDate(nextDate);
  };

  const goToPrevDay = (currentDate) => {
...
//             color="black"
//           />
//           <Text>{formattedDate || 'No date available'}</Text>
