...
mongoose.connect("mongodb+srv://toyesh:Toyesh@cluster0.7to3n.mongodb.net/", {
...
app.post("/addEmployee", async(req, res) => {
    try {
        ...
        res.status(201).json({message: "Employee saved sucessfully", employee: newEmployee});
    } catch(err) {
...
app.post("/attendances", async (req, res) => {
  ...
  app.get("/attendances-report-all-employees", async (req, res) => {
      try {
